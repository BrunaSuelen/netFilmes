     ...
     db.get(`SELECT COUNT(*) as count FROM Serie`, (err, row) => {
        if (err) {
            ...
            if (row.count == 0) {
                ...
                ('TODO MUNDO ODEIA O CRIS', 'http://localhost:5000/uploads/todo-mundo-odeia-o-cris.png', 'assistido', 'Chris é um adolescente crescendo no Broolkyn dos anos 80 com uma excêntrica família composta pelo pai Julius, sua mãe Rochelle, sua irmã mimada Tonya e seu irmão Drew, que é bastante popular.', 2, 1),
                ('VIKINS', 'http://localhost:5000/uploads/vikings.png', 'assistido', 'A série acompanha a saga dos navegadores nórdicos que exploram - e conquistam - novos territórios nos tempos medievais.', 2, 1),
                ...
                ('TODO MUNDO ODEIA O CRIS', 'http://localhost:5000/uploads/todo-mundo-odeia-o-cris.png', 'assistido', 'Chris é um adolescente crescendo no Broolkyn dos anos 80 com uma excêntrica família composta pelo pai Julius, sua mãe Rochelle, sua irmã mimada Tonya e seu irmão Drew, que é bastante popular.', 2, 2),
