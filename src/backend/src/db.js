     ...
     db.get(`SELECT COUNT(*) as count FROM Serie`, (err, row) => {
        if (err) {
            ...
            if (row.count == 0) {
                ...
                ('Série 1', 'http://localhost:5000/uploads/serie.png', 'assistido', 'Comentário 1', 1, 1),
                ('Série 2', 'http://localhost:5000/uploads/serie.png', 'assistido', 'Comentário 2', 2, 1),
                ('Série 3', 'http://localhost:5000/uploads/serie.png', 'assistido', 'Comentário 3', 3, 1),
                ('Série 4', 'http://localhost:5000/uploads/serie.png', 'assistido', 'Comentário 4', 4, 1),
                ('Série 5', 'http://localhost:5000/uploads/serie.png', 'assistido', 'Comentário 5', 5, 1),
                ('Série 6', 'http://localhost:5000/uploads/serie.png', 'assistido', 'Comentário 6', 6, 1),
                ('Série 7', 'http://localhost:5000/uploads/serie.png', 'assistido', 'Comentário 7', 7, 1),
                ('Série 8', 'http://localhost:5000/uploads/serie.png', 'assistido', 'Comentário 8', 8, 1),
                ('Série 9', 'http://localhost:5000/uploads/serie.png', 'assistido', 'Comentário 9', 9, 1),
                ('Série 10', 'http://localhost:5000/uploads/serie.png', 'assistido', 'Comentário 10', 10, 1);
              `);
